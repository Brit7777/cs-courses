...
<header id="main_header">
   ...
   function deleteCheck()
     {
      if(Delete.password.value.length < 1 )
      {
...
<center>
<table>
<form name=modify method=post action="deleteProcess.jsp?num=<%=num%>" OnSubmit='return deleteCheck()'>
  <tr>
   <td>
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
     <tr text-align:center;">
      <td width="5"></td>
      <td align="center" font style="color:#FF6666;font-size:50px;">delete</td>
      <td width="5"></td>
     </tr>
    </table>
   <table>
